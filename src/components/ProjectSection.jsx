...
const ProjectSection = () => {
  return (
    <section className="py-12">
      ...
      <header className="bg-gray-800 text-white py-4" id="projects">
        <h1 className="text-3xl font-bold text-center uppercase">PROJECTS</h1>
      </header>

      <div className="projects-container flex flex-wrap justify-center gap-8 p-8">
        {/* Project 1 */}
        <div className="project-card bg-white p-6 rounded-lg shadow-lg w-80 hover:bg-opacity-70 relative transition-opacity cursor-pointer" onClick={() => window.location.href = 'https://github.com/Amber-bisht/linkshare'}>
        ...
        {/* Project 2 */}
        <div className="project-card bg-white p-6 rounded-lg shadow-lg w-80 hover:bg-opacity-70 relative transition-opacity cursor-pointer" onClick={() => window.location.href = 'https://github.com/Amber-bisht/cab_booking'}>
        ...
        {/* Project 3 */}
        <div className="project-card bg-white p-6 rounded-lg shadow-lg w-80 hover:bg-opacity-70 relative transition-opacity cursor-pointer" onClick={() => window.location.href = 'https://github.com/Amber-bisht/e-commerce'}>
